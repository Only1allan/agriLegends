    ...
    <div className="min-h-dvh flex items-center justify-center bg-soil-900 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold font-display text-cream">Join FarmWise</h1>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-soil-700 border border-border rounded-lg px-4 py-3 text-cream placeholder-muted focus:outline-none focus:border-canopy-400 transition"
            />
            <p className="text-muted text-xs mt-1">Kenyan number starting with 07 or +254</p>
          </div>
          <div>
          ...
          <p className="text-center text-muted text-sm">
            ...
            <Link href="/login" className="text-canopy-300 hover:text-canopy-400">
              Sign in
            </Link>
          </p>
        </form>
